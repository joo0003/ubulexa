...
@PetiteBean
public class TodayEventTemplatedSpeechBuilder extends AbstractTemplatedSpeechBuilder {
  ...
  public String build(Props dictionary, CalendarEvent event) {
    ...
    return parseTemplate(
        dictionary.getValue(Constants.CALENDAR_EVENTS_TODAY_SPEECH_TEXT_KEY),
        params
    );
  }
}
