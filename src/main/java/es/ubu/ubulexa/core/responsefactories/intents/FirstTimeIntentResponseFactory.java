package es.ubu.ubulexa.core.responsefactories.intents;
...
@PetiteBean
public class FirstTimeIntentResponseFactory extends AbstractResponseFactory {
  ...
  public Optional<Response> build(HandlerInput handlerInput, ResponseTemplate template) {
    ...
    String speechText = dictionary.getValue(
        Constants.FIRST_TIME_INTENT_SPEECH_TEXT_KEY
    );
